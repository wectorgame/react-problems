...
const Problem8 = () => {
  ...
  }, [products, searchTerm, category, showOnlyInStock])
  ...
  const deferredProducts = useDeferredValue(sortedProducts)
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <p>
          Фильтрация и сортировка 2000 товаров блокирует UI, делая приложение
          неотзывчивым. При изменении фильтров пользователь не может
      ...
      <div style={{ marginTop: "20px" }}>
        ...
        <ul>
          ...
          <li>
            Пользователь не может взаимодействовать с интерфейсом во время
            обработки
          </li>
