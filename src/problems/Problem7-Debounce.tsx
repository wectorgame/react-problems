  ...
  const results = [
    {
      ...
      description: "Оптимизация React приложений",
      category: "Frontend",
    },
    {
      id: 2,
      title: "JavaScript Tips",
      description: "Полезные советы по JavaScript",
      category: "Programming",
    },
    {
      id: 3,
      title: "TypeScript Guide",
      description: "Полное руководство по TypeScript",
      category: "Programming",
    },
    {
      id: 4,
      title: "CSS Grid Layout",
      description: "Современная верстка с CSS Grid",
      category: "Frontend",
    },
    {
      id: 5,
      title: "Node.js Best Practices",
      description: "Лучшие практики для Node.js",
      category: "Backend",
    },
  ]
...
const Problem7 = () => {
  ...
  useEffect(() => {
    ...
    mockSearchAPI(debounceValue).then((data) => {
      setResults(data)
      setLoading(false)
    })
  }, [debounceValue])
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <p>
          Поиск выполняется при каждом изменении input, что приводит к
          множественным API запросам и плохому пользовательскому опыту. При
          быстром вводе генерируется много ненужных запросов.
        </p>
      </div>
      ...
      <div style={{ marginBottom: "20px" }}>
        <div style={{ display: "flex", gap: "20px", marginBottom: "10px" }}>
          <span>
            Запросов к API: <strong>{apiCalls}</strong>
          </span>
          <span>
            Поисковых запросов: <strong>{searchCount}</strong>
          </span>
          <span>
            Результатов: <strong>{results.length}</strong>
          </span>
        </div>
