...
interface UseTodosReturn {
  ...
  setNewTodoPriority: (priority: "low" | "medium" | "high") => void
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <p>
          Логика управления todos разбросана по компоненту, нет
          переиспользования кода, отсутствует мемоизация и оптимизация для
          больших списков.
        </p>
      </div>
